...
public class FirebaseSupportPhrase {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static boolean FirebaseResetSupportPhrase(Context context) {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static boolean FirebaseDeleteAllSupportPhrase(String firebaseKey, Context context) {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static void firebaseDeleteOneSupportPhrase(String mSupportPhraseId) {

        mDatabaseReference = FirebaseDatabase.getInstance().getReference(TABLE_SUPPORT_PHRASE);

        mFirebaseQuery = mDatabaseReference.orderByChild(FIELD_SUPPORT_PHRASE_ID).equalTo(mSupportPhraseId);
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static boolean FirebaseUpdateSupportPhrase(
            Context context,
        ...
        try {
            ...
            mDatabaseReference.child(recordId).child(FIELD_SUPPORT_PHRASE_ID).setValue(recordId);
            mDatabaseReference.child(recordId).child(FIELD_SUPPORT_PHRASE_LANGUAGE).setValue(recordLanguage);
            mDatabaseReference.child(recordId).child(FIELD_SUPPORT_PHRASE_NUMBER).setValue(recordNumber);
            mDatabaseReference.child(recordId).child(FIELD_SUPPORT_PHRASE_AUTHOR).setValue(recordAuthor);
            mDatabaseReference.child(recordId).child(FIELD_SUPPORT_PHRASE_TEXT).setValue(recordText);
            mDatabaseReference.child(recordId).child(FIELD_SUPPORT_PHRASE_CREATION).setValue(recordDateCreation);
            mDatabaseReference.child(recordId).child(FIELD_SUPPORT_PHRASE_UPDATE).setValue(recordDateUpdate);
            mDatabaseReference.child(recordId).child(FIELD_SUPPORT_PHRASE_SYNC).setValue(recordDateSync);
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static void firebaseUpdateSingleSupportPhrase(
            final String recordId,
            final String recordLanguage,
            final String recordNumber,
            final String recordAuthor,
        ...
        mFirebaseQuery = mDatabaseReference.orderByChild(FIELD_SUPPORT_PHRASE_ID).equalTo(recordId);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        snapshot.child(recordId).child(FIELD_SUPPORT_PHRASE_ID).getRef().setValue(recordId);
                        snapshot.child(recordId).child(FIELD_SUPPORT_PHRASE_LANGUAGE).getRef().setValue(recordLanguage);
                        snapshot.child(recordId).child(FIELD_SUPPORT_PHRASE_NUMBER).getRef().setValue(recordNumber);
                        snapshot.child(recordId).child(FIELD_SUPPORT_PHRASE_AUTHOR).getRef().setValue(recordAuthor);
                        snapshot.child(recordId).child(FIELD_SUPPORT_PHRASE_TEXT).getRef().setValue(recordText);
                        snapshot.child(recordId).child(FIELD_SUPPORT_PHRASE_CREATION).getRef().setValue(recordDateCreation);
                        snapshot.child(recordId).child(FIELD_SUPPORT_PHRASE_UPDATE).getRef().setValue(recordDateUpdate);
                        snapshot.child(recordId).child(FIELD_SUPPORT_PHRASE_SYNC).getRef().setValue(recordDateSync);
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static void firebaseCreateSupportPhrase(
            Context context,
            final String recordId,
            final String recordLanguage,
            final String recordNumber,
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelSupportPhrase> GetOneSupportPhrase(String mSupportPhraseId) {

        final List<ModelSupportPhrase> list = new ArrayList<>();
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelSupportPhrase> ListGetAllSupportPhrase() {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelSupportPhrase> GetListByLanguage() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        mLanguage = snapshot.child(FIELD_SUPPORT_PHRASE_LANGUAGE).getValue(String.class);
