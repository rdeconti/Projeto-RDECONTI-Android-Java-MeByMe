...
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.YOU_REAL_PHASES;
...
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_DATE_CREATION;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_DATE_SYNC;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_DATE_UPDATE;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_EXPERIENCE;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_ID;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_NUMBER;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_NUMBER_ACTIONS;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_NUMBER_PHOTOS;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_NUMBER_POINTS;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_NUMBER_SHARING;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_PHASE;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_QUESTION_TEXT;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_STATUS;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_TEXT;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableFields.FIELD_YOU_ANSWER_USER_ID;
import static com.prosper.day.databasedefinition.SqliteDatabaseTableNames.TABLE_MODULE_YOU_ANSWER;

public class SqliteModuleYouAnswer {
    ...
    public static long sqliteCounter(Context context) {
        ...
        mLongRecordCounter = DatabaseUtils.queryNumEntries(mSqLiteDatabase, TABLE_MODULE_YOU_ANSWER);
    ...
    public static void sqliteInsert(
        ...
        try {
            ...
            mContentValues.put(FIELD_YOU_ANSWER_USER_ID, recordUserId);
            mContentValues.put(FIELD_YOU_ANSWER_PHASE, recordPhase);
            mContentValues.put(FIELD_YOU_ANSWER_NUMBER, recordNumber);
            mContentValues.put(FIELD_YOU_ANSWER_STATUS, recordStatus);
            mContentValues.put(FIELD_YOU_ANSWER_EXPERIENCE, recordExperience);
            mContentValues.put(FIELD_YOU_ANSWER_QUESTION_TEXT, recordQuestion);
            mContentValues.put(FIELD_YOU_ANSWER_TEXT, recordAnswer);
            mContentValues.put(FIELD_YOU_ANSWER_NUMBER_POINTS, recordNumberPoints);
            mContentValues.put(FIELD_YOU_ANSWER_NUMBER_SHARING, recordNumberSharing);
            mContentValues.put(FIELD_YOU_ANSWER_NUMBER_PHOTOS, recordNumberPhotos);
            mContentValues.put(FIELD_YOU_ANSWER_NUMBER_ACTIONS, recordNumberActions);
            mContentValues.put(FIELD_YOU_ANSWER_DATE_CREATION, recordDateCreation);
            mContentValues.put(FIELD_YOU_ANSWER_DATE_UPDATE, recordDateUpdate);
            mContentValues.put(FIELD_YOU_ANSWER_DATE_SYNC, recordDateSync);

            mSqLiteDatabase.insert(TABLE_MODULE_YOU_ANSWER, null, mContentValues);
    ...
    public static void sqliteUpdateText(
        ...
        try {
            ...
            mSqLiteDatabase.update(TABLE_MODULE_YOU_ANSWER, mContentValues, FIELD_YOU_ANSWER_ID + " = ?", new String[]{String.valueOf(recordId)});
            mSqLiteDatabase.setTransactionSuccessful();
    ...
    public static void sqliteDeleteAll(Context context) {
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_YOU_ANSWER;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mIntKeyFromSqlite = mCursor.getInt(mCursor.getColumnIndex(FIELD_YOU_ANSWER_ID));
                mSqLiteDatabase.delete(TABLE_MODULE_YOU_ANSWER, FIELD_YOU_ANSWER_ID + " = ?", new String[]{String.valueOf(mIntKeyFromSqlite)});
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleYouAnswer> sqliteGetAll(Context context, String stringStatus) {

        List<ModelModuleYouAnswer> list = new ArrayList<>();
        ...
        switch (stringStatus) {
            ...
            case STATUS_IGNORED:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_YOU_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_YOU_ANSWER_STATUS + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                list.add(new ModelModuleYouAnswer(

                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_ID)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_USER_ID)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_PHASE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_NUMBER)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_STATUS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_EXPERIENCE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_QUESTION_TEXT)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_TEXT)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_NUMBER_POINTS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_NUMBER_SHARING)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_NUMBER_PHOTOS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_NUMBER_ACTIONS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_DATE_CREATION)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_DATE_UPDATE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_DATE_SYNC))));
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleYouAnswer> sqliteGetPhase(Context context, String stringPhase, String stringStatus) {
        ...
        switch (stringStatus) {
            ...
            case STATUS_ALL:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_YOU_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_YOU_ANSWER_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES;
                break;
            ...
            case STATUS_IGNORED:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_YOU_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_YOU_ANSWER_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES
                        + SQLITE_COMMAND_AND + FIELD_YOU_ANSWER_STATUS + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleYouAnswer> sqliteGetOne(Context context, String mStringRecordId) {
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_YOU_ANSWER
                + SQLITE_COMMAND_WHERE + FIELD_YOU_ANSWER_ID + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + mStringRecordId + SQLITE_COMMAND_QUOTES;
    ...
    public static void sqliteDeleteOne(
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_YOU_ANSWER
                + SQLITE_COMMAND_WHERE + FIELD_YOU_ANSWER_ID + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + recordId + SQLITE_COMMAND_QUOTES;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mSqLiteDatabase.delete(TABLE_MODULE_YOU_ANSWER, FIELD_YOU_ANSWER_ID + " = ?", new String[]{String.valueOf(recordId)});
    ...
    public static void sqliteGraphEvolution(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                String graphStatus = mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_STATUS));
    ...
    public static int[][] sqliteReportAnalysis(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mGraphPhase = mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_PHASE));
                mGraphStatus = mCursor.getString(mCursor.getColumnIndex(FIELD_YOU_ANSWER_STATUS));
    ...
    private static void initializeMultidimensionalArray() {
        ...
        mIndexTotalLine = YOU_REAL_PHASES;
