...
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.ACTION_REAL_PHASES;
...
public class SqliteModuleActionAnswer {
    ...
    public static long sqliteCounter(Context context) {
        ...
        mLongRecordCounter = DatabaseUtils.queryNumEntries(mSqLiteDatabase, TABLE_MODULE_ACTION_ANSWER);
    ...
    public static void sqliteInsert(
        ...
        try {
            ...
            mContentValues.put(FIELD_ACTION_ANSWER_USER_ID, recordUserId);
            mContentValues.put(FIELD_ACTION_ANSWER_PHASE, recordPhase);
            mContentValues.put(FIELD_ACTION_ANSWER_NUMBER, recordNumber);
            mContentValues.put(FIELD_ACTION_ANSWER_TEXT, recordAnswer);
            mContentValues.put(FIELD_ACTION_ANSWER_STATUS, recordStatus);
            mContentValues.put(FIELD_ACTION_ANSWER_EXPERIENCE, recordExperience);
            mContentValues.put(FIELD_ACTION_ANSWER_PRIORITY, recordPriority);
            mContentValues.put(FIELD_ACTION_ANSWER_FREQUENCY, recordFrequency);
            mContentValues.put(FIELD_ACTION_ANSWER_COSTS, recordCosts);
            mContentValues.put(FIELD_ACTION_ANSWER_NUMBER_POINTS, recordNumberPoints);
            mContentValues.put(FIELD_ACTION_ANSWER_NUMBER_SHARING, recordNumberSharing);
            mContentValues.put(FIELD_ACTION_ANSWER_NUMBER_PHOTOS, recordNumberPhotos);
            mContentValues.put(FIELD_ACTION_ANSWER_NUMBER_ACTIONS, recordNumberActions);
            mContentValues.put(FIELD_ACTION_ANSWER_DATE_CREATION, recordDateCreation);
            mContentValues.put(FIELD_ACTION_ANSWER_DATE_UPDATE, recordDateUpdate);
            mContentValues.put(FIELD_ACTION_ANSWER_DATE_SYNC, recordDateSync);

            mSqLiteDatabase.insert(TABLE_MODULE_ACTION_ANSWER, null, mContentValues);
    ...
    public static void sqliteUpdateText(
        ...
        try {
            ...
            mSqLiteDatabase.update(TABLE_MODULE_ACTION_ANSWER, mContentValues, FIELD_ACTION_ANSWER_ID + " = ?", new String[]{String.valueOf(recordId)});
            mSqLiteDatabase.setTransactionSuccessful();
    ...
    public static void sqliteDeleteAll(Context context) {
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mIntKeyFromSqlite = mCursor.getInt(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_ID));
                mSqLiteDatabase.delete(TABLE_MODULE_ACTION_ANSWER, FIELD_ACTION_ANSWER_ID + " = ?", new String[]{String.valueOf(mIntKeyFromSqlite)});
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleActionAnswer> sqliteGetAll(Context context, String stringStatus) {

        List<ModelModuleActionAnswer> list = new ArrayList<>();
        list.clear();
        ...
        switch (stringStatus) {
            ...
            case STATUS_IGNORED:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_STATUS + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
            ...
            case COSTS_LOW:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_COSTS + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
                break;
            ...
            case PRIORITY_LOW:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_PRIORITY + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
                break;
            ...
            case FREQUENCY_YEARLY:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_FREQUENCY + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
                break;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                list.add(new ModelModuleActionAnswer(

                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_ID)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_USER_ID)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_PHASE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_NUMBER)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_TEXT)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_STATUS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_EXPERIENCE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_PRIORITY)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_FREQUENCY)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_COSTS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_NUMBER_POINTS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_NUMBER_SHARING)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_NUMBER_PHOTOS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_NUMBER_ACTIONS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_DATE_CREATION)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_DATE_UPDATE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_DATE_SYNC))));
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleActionAnswer> sqliteGetPhase(Context context, String stringPhase, String stringStatus) {
        ...
        switch (stringStatus) {
            ...
            case STATUS_ALL:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES;
                break;
            ...
            case STATUS_IGNORED:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES
                        + SQLITE_COMMAND_AND + FIELD_ACTION_ANSWER_STATUS + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
            ...
            case COSTS_LOW:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES
                        + SQLITE_COMMAND_AND + FIELD_ACTION_ANSWER_COSTS + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
                break;
            ...
            case PRIORITY_LOW:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES
                        + SQLITE_COMMAND_AND + FIELD_ACTION_ANSWER_PRIORITY + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
                break;
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleActionAnswer> sqliteGetOne(Context context, String mStringRecordId) {
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_ID + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + mStringRecordId + SQLITE_COMMAND_QUOTES;
    ...
    public static void sqliteDeleteOne(
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_ACTION_ANSWER
                + SQLITE_COMMAND_WHERE + FIELD_ACTION_ANSWER_ID + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + recordId + SQLITE_COMMAND_QUOTES;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mSqLiteDatabase.delete(TABLE_MODULE_ACTION_ANSWER, FIELD_ACTION_ANSWER_ID + " = ?", new String[]{String.valueOf(recordId)});
    ...
    public static void sqliteGraphEvolution(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                String graphStatus = mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_STATUS));
    ...
    public static void sqliteGraphPriority(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                String graphPriority = mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_PRIORITY));
    ...
    public static void sqliteGraphCosts(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                String graphCosts = mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_COSTS));
    ...
    public static void sqliteGraphFrequency(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                String graphFrequency = mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_FREQUENCY));
    ...
    public static int[][] sqliteReportAnalysis(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mGraphPhase = mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_PHASE));
                mGraphStatus = mCursor.getString(mCursor.getColumnIndex(FIELD_ACTION_ANSWER_STATUS));
    ...
    private static void initializeMultidimensionalArray() {
        ...
        mIndexTotalLine = ACTION_REAL_PHASES;
