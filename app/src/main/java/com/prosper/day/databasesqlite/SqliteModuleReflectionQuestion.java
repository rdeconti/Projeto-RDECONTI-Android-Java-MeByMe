...
public class SqliteModuleReflectionQuestion {
    ...
    public static long sqliteCounter(Context context) {
        ...
        mLongRecordCounter = DatabaseUtils.queryNumEntries(mSqLiteDatabase, TABLE_MODULE_REFLECTION_QUESTION);
    ...
    public static void sqliteInsert(
        ...
        try {
            ...
            mContentValues.put(FIELD_REFLECTION_QUESTION_LANGUAGE, recordLanguage);
            mContentValues.put(FIELD_REFLECTION_QUESTION_PHASE, recordPhase);
            mContentValues.put(FIELD_REFLECTION_QUESTION_NUMBER, recordNumber);
            mContentValues.put(FIELD_REFLECTION_QUESTION_TEXT, recordText);
            mContentValues.put(FIELD_REFLECTION_QUESTION_CREATION, recordDateCreation);
            mContentValues.put(FIELD_REFLECTION_QUESTION_UPDATE, recordDateUpdate);
            mContentValues.put(FIELD_REFLECTION_QUESTION_SYNC, recordDateSync);

            mSqLiteDatabase.insert(TABLE_MODULE_REFLECTION_QUESTION, null, mContentValues);
    ...
    public static void sqliteDeleteAll(Context context) {
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_REFLECTION_QUESTION;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mIntKeyFromSqlite = mCursor.getInt(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_ID));
                mSqLiteDatabase.delete(TABLE_MODULE_REFLECTION_QUESTION, FIELD_REFLECTION_QUESTION_ID + " = ?", new String[]{String.valueOf(mIntKeyFromSqlite)});
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleReflectionQuestion> sqliteGetAll(Context context) {

        List<ModelModuleReflectionQuestion> list = new ArrayList<>();
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                list.add(new ModelModuleReflectionQuestion(

                        mCursor.getString(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_ID)),
                        mCursor.getString(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_LANGUAGE)),
                        mCursor.getString(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_PHASE)),
                        mCursor.getString(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_NUMBER)),
                        mCursor.getString(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_TEXT)),
                        mCursor.getString(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_CREATION)),
                        mCursor.getString(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_UPDATE)),
                        mCursor.getString(mCursor.getColumnIndex(FIELD_REFLECTION_QUESTION_SYNC))));
