...
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.LIFE_REAL_PHASES;
...
import static com.prosper.day.applicationdefinition.ApplicationDefinitionNumberValues.INT_GRAPH_VALUE_16;
...
public class SqliteModuleLifeAnswer {
    ...
    public static long sqliteCounter(Context context) {
        ...
        mLongRecordCounter = DatabaseUtils.queryNumEntries(mSqLiteDatabase, TABLE_MODULE_LIFE_ANSWER);
    ...
    public static void sqliteInsert(
        ...
        try {
            ...
            mContentValues.put(FIELD_LIFE_ANSWER_USER_ID, recordUserId);
            mContentValues.put(FIELD_LIFE_ANSWER_PHASE, recordPhase);
            mContentValues.put(FIELD_LIFE_ANSWER_NUMBER, recordNumber);
            mContentValues.put(FIELD_LIFE_ANSWER_STATUS, recordStatus);
            mContentValues.put(FIELD_LIFE_ANSWER_EXPERIENCE, recordExperience);
            mContentValues.put(FIELD_LIFE_ANSWER_GRADE, recordGrade);
            mContentValues.put(FIELD_LIFE_ANSWER_QUESTION, recordQuestion);
            mContentValues.put(FIELD_LIFE_ANSWER_NUMBER_POINTS, recordNumberPoints);
            mContentValues.put(FIELD_LIFE_ANSWER_NUMBER_SHARING, recordNumberSharing);
            mContentValues.put(FIELD_LIFE_ANSWER_NUMBER_PHOTOS, recordNumberPhotos);
            mContentValues.put(FIELD_LIFE_ANSWER_NUMBER_ACTIONS, recordNumberActions);
            mContentValues.put(FIELD_LIFE_ANSWER_DATE_CREATION, recordDateCreation);
            mContentValues.put(FIELD_LIFE_ANSWER_DATE_UPDATE, recordDateUpdate);
            mContentValues.put(FIELD_LIFE_ANSWER_DATE_SYNC, recordDateSync);

            mSqLiteDatabase.insert(TABLE_MODULE_LIFE_ANSWER, null, mContentValues);
    ...
    public static void sqliteUpdateNumberPhotos(
        ...
        try {
            ...
            mSqLiteDatabase.update(TABLE_MODULE_LIFE_ANSWER, mContentValues, FIELD_LIFE_ANSWER_ID + " = ?", new String[]{String.valueOf(recordId)});
            mSqLiteDatabase.setTransactionSuccessful();
    ...
    public static void sqliteDeleteAll(Context context) {
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_LIFE_ANSWER;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mIntKeyFromSqlite = mCursor.getInt(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_ID));
                mSqLiteDatabase.delete(TABLE_MODULE_LIFE_ANSWER, FIELD_LIFE_ANSWER_ID + " = ?", new String[]{String.valueOf(mIntKeyFromSqlite)});
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleLifeAnswer> sqliteGetAll(Context context, String stringStatus) {

        List<ModelModuleLifeAnswer> list = new ArrayList<>();
        ...
        switch (stringStatus) {
            ...
            case STATUS_IGNORED:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_LIFE_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_LIFE_ANSWER_STATUS + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                list.add(new ModelModuleLifeAnswer(

                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_ID)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_USER_ID)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_PHASE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_NUMBER)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_STATUS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_EXPERIENCE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_GRADE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_QUESTION)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_NUMBER_POINTS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_NUMBER_SHARING)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_NUMBER_PHOTOS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_NUMBER_ACTIONS)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_DATE_CREATION)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_DATE_UPDATE)),
                    mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_DATE_SYNC))));
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleLifeAnswer> sqliteGetPhase(Context context, String stringPhase, String stringStatus) {
        ...
        switch (stringStatus) {
            ...
            case STATUS_ALL:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_LIFE_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_LIFE_ANSWER_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES;
            ...
            case STATUS_IGNORED:
                mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_LIFE_ANSWER
                        + SQLITE_COMMAND_WHERE + FIELD_LIFE_ANSWER_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES
                        + SQLITE_COMMAND_AND + FIELD_LIFE_ANSWER_STATUS + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringStatus + SQLITE_COMMAND_QUOTES;
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static List<ModelModuleLifeAnswer> sqliteGetOne(Context context, String mStringRecordId) {
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_LIFE_ANSWER
                + SQLITE_COMMAND_WHERE + FIELD_LIFE_ANSWER_ID + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + mStringRecordId + SQLITE_COMMAND_QUOTES;
    ...
    public static void sqliteDeleteOne(
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_MODULE_LIFE_ANSWER
                + SQLITE_COMMAND_WHERE + FIELD_LIFE_ANSWER_ID + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + recordId + SQLITE_COMMAND_QUOTES;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mSqLiteDatabase.delete(TABLE_MODULE_LIFE_ANSWER, FIELD_LIFE_ANSWER_ID + " = ?", new String[]{String.valueOf(recordId)});
    ...
    public static void sqliteGraphEvolution(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mGraphStatus = mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_STATUS));
    ...
    public static void sqliteGraphAnalysis(Context context) {
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mGraphPhase = mCursor.getString(mCursor.getColumnIndex(FIELD_LIFE_ANSWER_PHASE));
    ...
    private static void initializeMultidimensionalArray() {
        ...
        mIndexTotalLine = LIFE_REAL_PHASES;
