...
public class SqliteSupportHelp {
    ...
    public static long sqliteCounter(Context context) {
        ...
        mLongRecordCounter = DatabaseUtils.queryNumEntries(mSqLiteDatabase, TABLE_SUPPORT_HELP);
    ...
    public static void sqliteInsert(
        ...
        try {
            ...
            mContentValues.put(FIELD_SUPPORT_HELP_LANGUAGE, recordLanguage);
            mContentValues.put(FIELD_SUPPORT_HELP_PHASE, recordPhase);
            mContentValues.put(FIELD_SUPPORT_HELP_TEXT, recordHelpText);
            mContentValues.put(FIELD_SUPPORT_HELP_CREATION, recordDateCreation);
            mContentValues.put(FIELD_SUPPORT_HELP_UPDATE, recordDateUpdate);
            mContentValues.put(FIELD_SUPPORT_HELP_SYNC, recordDateSync);

            mSqLiteDatabase.insert(TABLE_SUPPORT_HELP, null, mContentValues);
    ...
    public static void sqliteDeleteAll(Context context) {
        ...
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_SUPPORT_HELP;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mIntKeyFromSqlite = mCursor.getInt(mCursor.getColumnIndex(FIELD_SUPPORT_HELP_ID));
                mSqLiteDatabase.delete(TABLE_SUPPORT_HELP, FIELD_SUPPORT_HELP_ID + " = ?", new String[]{String.valueOf(mIntKeyFromSqlite)});
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static String sqliteGetOne(Context context, String stringPhase) {

        mStringReturned = context.getString(R.string.message_application_problem);
        
        mStringSelectQuery = SQLITE_COMMAND_SELECT + SQLITE_COMMAND_ASTERISK + SQLITE_COMMAND_FROM + TABLE_SUPPORT_HELP
                + SQLITE_COMMAND_WHERE + FIELD_SUPPORT_HELP_PHASE + SQLITE_COMMAND_EQUAL + SQLITE_COMMAND_QUOTES + stringPhase + SQLITE_COMMAND_QUOTES;
        ...
        if (mCursor != null && mCursor.moveToFirst()) {
            ...
            do {
                ...
                mStringReturned = mCursor.getString(mCursor.getColumnIndex(FIELD_SUPPORT_HELP_TEXT));
