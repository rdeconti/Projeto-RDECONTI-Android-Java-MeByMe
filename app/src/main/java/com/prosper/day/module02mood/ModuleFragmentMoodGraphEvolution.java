...
public class ModuleFragmentMoodGraphEvolution extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentMoodGraphEvolution() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mood_graph_fragment, viewGroup, false);
    ...
    private void readDataFromDatabase() {
        ...
        SqliteModuleMoodAnswer.sqliteGraphEvolution(mContext);
