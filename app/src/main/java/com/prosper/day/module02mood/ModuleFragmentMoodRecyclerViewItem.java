...
public class ModuleFragmentMoodRecyclerViewItem extends Fragment {
    ...
    List<ModelModuleMoodAnswer> listAll;

    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentMoodRecyclerViewItem() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = inflater.inflate(R.layout.mood_recyclerview_fragment_list, viewGroup, false);
    ...
    private void generateRecyclerView() {
        ...
        switch (stringCurrentPhaseCode) {
            ...
            case MOOD_PHASE_CODE_02_OV:
                listAll = SqliteModuleMoodAnswer.sqliteGetAll(mContext, mCurrentButtonFunction);
                break;
            ...
            case MOOD_PHASE_CODE_02_05:
                listAll = SqliteModuleMoodAnswer.sqliteGetPhase(mContext, stringCurrentPhaseCode, mCurrentButtonFunction);
                break;
        ...
        if (Objects.requireNonNull(listAll).size() == INT_NUMBER_00) {
            ...
            mRecyclerView.setAdapter(new ModuleFragmentMoodRecyclerViewList(listAll, mContext));
