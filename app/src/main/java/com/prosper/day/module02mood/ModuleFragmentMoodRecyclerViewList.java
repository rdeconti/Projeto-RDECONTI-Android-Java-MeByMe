...
public class ModuleFragmentMoodRecyclerViewList extends RecyclerView.Adapter<ModuleFragmentMoodRecyclerViewList.ViewHolder> {
    ...
    private final List<ModelModuleMoodAnswer> mValues;

    // *********************************************************************************************
    // *********************************************************************************************
    ModuleFragmentMoodRecyclerViewList(List<ModelModuleMoodAnswer> items, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.mood_recyclerview_fragment_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        ModelModuleMoodAnswer model = mValues.get(position);
        ...
        holder.mView.setOnClickListener(view -> {
            ...
            mStringCurrentFragment = "ModuleFragmentMoodRecyclerViewList";

            mAppCompatActivity = (AppCompatActivity) view.getContext();
            mAppCompatActivity.getSupportFragmentManager().beginTransaction()
                    .replace(R.id.mainConstraintLayout, new ModuleFragmentMoodCrud(), mStringCurrentFragment)
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    private void uploadLayoutData(ViewHolder holder, ModelModuleMoodAnswer model) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ModelModuleMoodAnswer recyclerViewItem;
