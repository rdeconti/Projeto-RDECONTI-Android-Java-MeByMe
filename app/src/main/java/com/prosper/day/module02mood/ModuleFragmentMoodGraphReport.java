...
public class ModuleFragmentMoodGraphReport extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentMoodGraphReport() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mood_report_fragment, viewGroup, false);
    ...
    private void initializeMultidimensionalArray() {
        ...
        mMultiArrayTotal = SqliteModuleMoodAnswer.sqliteReportAnalysis(mContext);
    ...
    private void generateReportBodyNumber() {
        ...
        for(mIndexArrayLine = 0; mIndexArrayLine < MOOD_REAL_PHASES; mIndexArrayLine++){
    ...
    private void generateReportLineName() {
        ...
        switch (mIndexArrayLine) {
            ...
            case INT_NUMBER_00:
                addToTableRow(mContext.getString(R.string.label_mood_very_sad), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_01:
                addToTableRow(mContext.getString(R.string.label_mood_sad), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_02:
                addToTableRow(mContext.getString(R.string.label_mood_indifferent), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_03:
                addToTableRow(mContext.getString(R.string.label_mood_happy), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_04:
                addToTableRow(mContext.getString(R.string.label_mood_very_happy), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;
