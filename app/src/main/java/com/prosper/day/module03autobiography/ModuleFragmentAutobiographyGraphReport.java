...
public class ModuleFragmentAutobiographyGraphReport extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentAutobiographyGraphReport() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.autobiography_report_fragment, viewGroup, false);
    ...
    private void initializeMultidimensionalArray() {
        ...
        mMultiArrayTotal = SqliteModuleAutobiographyAnswer.sqliteReportAnalysis(mContext);
    ...
    private void generateReportBodyNumber() {
        ...
        for(mIndexArrayLine = 0; mIndexArrayLine < AUTOBIOGRAPHY_REAL_PHASES; mIndexArrayLine++){
    ...
    private void generateReportLineName() {
        ...
        switch (mIndexArrayLine) {
            ...
            case INT_NUMBER_00:
                addToTableRow(mContext.getString(R.string.label_family), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;
            ...
            case INT_NUMBER_02:
                addToTableRow(mContext.getString(R.string.label_friends), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_03:
                addToTableRow(mContext.getString(R.string.label_enemies), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_04:
                addToTableRow(mContext.getString(R.string.label_education), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_05:
                addToTableRow(mContext.getString(R.string.label_jobs), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_06:
                addToTableRow(mContext.getString(R.string.label_challenges), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_07:
                addToTableRow(mContext.getString(R.string.label_memories), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_08:
                addToTableRow(mContext.getString(R.string.label_wins), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_09:
                addToTableRow(mContext.getString(R.string.label_defeats), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_10:
                addToTableRow(mContext.getString(R.string.label_forgiveness), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_11:
                addToTableRow(mContext.getString(R.string.label_gratitude), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_12:
                addToTableRow(mContext.getString(R.string.label_secrets), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_13:
                addToTableRow(mContext.getString(R.string.label_safety), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;
