...
public class ModuleFragmentAutobiographyRecyclerViewItem extends Fragment {
    ...
    List<ModelModuleAutobiographyAnswer> listAll;

    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentAutobiographyRecyclerViewItem() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = inflater.inflate(R.layout.autobiography_recyclerview_fragment_list, viewGroup, false);
    ...
    private void generateRecyclerView() {
        ...
        switch (stringCurrentPhaseCode) {
            ...
            case AUTOBIOGRAPHY_PHASE_CODE_03_OV:
                listAll = SqliteModuleAutobiographyAnswer.sqliteGetAll(mContext, mCurrentButtonFunction);
                break;
            ...
            case AUTOBIOGRAPHY_PHASE_CODE_03_14:
                listAll = SqliteModuleAutobiographyAnswer.sqliteGetPhase(mContext, stringCurrentPhaseCode, mCurrentButtonFunction);
                break;
        ...
        if (Objects.requireNonNull(listAll).size() == INT_NUMBER_00) {
            ...
            mRecyclerView.setAdapter(new ModuleFragmentAutobiographyRecyclerViewList(listAll, mContext));
