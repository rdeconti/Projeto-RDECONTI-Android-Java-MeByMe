...
public class ModuleFragmentAutobiographyGraphEvolution extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentAutobiographyGraphEvolution() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.autobiography_graph_fragment, viewGroup, false);
    ...
    private void readDataFromDatabase() {
        ...
        SqliteModuleAutobiographyAnswer.sqliteGraphEvolution(mContext);
