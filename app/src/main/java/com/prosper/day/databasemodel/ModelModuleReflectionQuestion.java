...
public class ModelModuleReflectionQuestion implements Parcelable {
    ...
    public ModelModuleReflectionQuestion() {
    ...
    public ModelModuleReflectionQuestion(String recordId, String recordLanguage, String recordPhase, String recordNumber, String recordText, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordLanguage = recordLanguage;
        this.recordPhase = recordPhase;
        this.recordNumber = recordNumber;
    ...
    protected ModelModuleReflectionQuestion(Parcel in) {
    ...
    public static final Creator<ModelModuleReflectionQuestion> CREATOR = new Creator<ModelModuleReflectionQuestion>() {
        @Override
        public ModelModuleReflectionQuestion createFromParcel(Parcel source) {
            return new ModelModuleReflectionQuestion(source);
        }

        @Override
        public ModelModuleReflectionQuestion[] newArray(int size) {
            return new ModelModuleReflectionQuestion[size];
        }
    };
}
