...
public class ModelModuleBeliefAnswer implements Parcelable {
    ...
    private String recordAnswerName;
    private String recordAnswerDescription;
    ...
    public ModelModuleBeliefAnswer() {
    ...
    public String getRecordAnswerName() {
        return recordAnswerName;
    }

    public void setRecordAnswerName(String recordAnswerName) {
        this.recordAnswerName = recordAnswerName;
    }

    public String getRecordAnswerDescription() {
        return recordAnswerDescription;
    }

    public void setRecordAnswerDescription(String recordAnswerDescription) {
        this.recordAnswerDescription = recordAnswerDescription;
    }
    ...
    public ModelModuleBeliefAnswer(String recordId, String recordUserId, String recordPhase, String recordSign, String recordStatus, String recordExperience, String recordAnswerName, String recordAnswerDescription, String recordNumberPoints, String recordNumberSharing, String recordNumberPhotos, String recordNumberActions, String recordDateCreation, String recordDateUpdate, String recordDateSync, byte[] recordImage) {
        this.recordId = recordId;
        this.recordUserId = recordUserId;
        this.recordPhase = recordPhase;
        this.recordSign = recordSign;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.recordAnswerName);
        dest.writeString(this.recordAnswerDescription);
    ...
    protected ModelModuleBeliefAnswer(Parcel in) {
        ...
        this.recordAnswerName = in.readString();
        this.recordAnswerDescription = in.readString();
    ...
    public static final Creator<ModelModuleBeliefAnswer> CREATOR = new Creator<ModelModuleBeliefAnswer>() {
        @Override
        public ModelModuleBeliefAnswer createFromParcel(Parcel source) {
            return new ModelModuleBeliefAnswer(source);
        }

        @Override
        public ModelModuleBeliefAnswer[] newArray(int size) {
            return new ModelModuleBeliefAnswer[size];
        }
    };
}
