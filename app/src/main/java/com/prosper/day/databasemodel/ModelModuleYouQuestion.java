...
public class ModelModuleYouQuestion implements Parcelable {
    ...
    public ModelModuleYouQuestion(String recordId, String recordLanguage, String recordPhase, String recordNumber, String recordText, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordLanguage = recordLanguage;
        this.recordPhase = recordPhase;
        this.recordNumber = recordNumber;
    ...
    protected ModelModuleYouQuestion(Parcel in) {
    ...
    public static final Creator<ModelModuleYouQuestion> CREATOR = new Creator<ModelModuleYouQuestion>() {
        @Override
        public ModelModuleYouQuestion createFromParcel(Parcel source) {
            return new ModelModuleYouQuestion(source);
        }

        @Override
        public ModelModuleYouQuestion[] newArray(int size) {
            return new ModelModuleYouQuestion[size];
        }
    };
}
