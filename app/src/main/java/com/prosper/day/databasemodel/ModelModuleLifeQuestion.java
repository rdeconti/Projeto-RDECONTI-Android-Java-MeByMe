...
public class ModelModuleLifeQuestion implements Parcelable {
    ...
    public ModelModuleLifeQuestion() {
    ...
    public ModelModuleLifeQuestion(String recordId, String recordLanguage, String recordPhase, String recordNumber, String recordText, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordLanguage = recordLanguage;
        this.recordPhase = recordPhase;
        this.recordNumber = recordNumber;
    ...
    protected ModelModuleLifeQuestion(Parcel in) {
    ...
    public static final Creator<ModelModuleLifeQuestion> CREATOR = new Creator<ModelModuleLifeQuestion>() {
        @Override
        public ModelModuleLifeQuestion createFromParcel(Parcel source) {
            return new ModelModuleLifeQuestion(source);
        }

        @Override
        public ModelModuleLifeQuestion[] newArray(int size) {
            return new ModelModuleLifeQuestion[size];
        }
    };
}
