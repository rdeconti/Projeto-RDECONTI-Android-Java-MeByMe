...
public class ModelSupportPhrase implements Parcelable {
    ...
    public ModelSupportPhrase(String recordId, String recordLanguage, String recordNumber, String recordAuthor, String recordText, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordLanguage = recordLanguage;
        this.recordNumber = recordNumber;
        this.recordAuthor = recordAuthor;
    ...
    protected ModelSupportPhrase(Parcel in) {
    ...
    public static final Creator<ModelSupportPhrase> CREATOR = new Creator<ModelSupportPhrase>() {
        @Override
        public ModelSupportPhrase createFromParcel(Parcel source) {
            return new ModelSupportPhrase(source);
        }

        @Override
        public ModelSupportPhrase[] newArray(int size) {
            return new ModelSupportPhrase[size];
        }
    };
}
