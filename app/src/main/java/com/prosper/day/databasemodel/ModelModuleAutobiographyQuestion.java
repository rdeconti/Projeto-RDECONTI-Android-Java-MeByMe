...
public class ModelModuleAutobiographyQuestion implements Parcelable {
    ...
    public ModelModuleAutobiographyQuestion() {
    ...
    public ModelModuleAutobiographyQuestion(String recordId, String recordLanguage, String recordPhase, String recordNumber, String recordText, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordLanguage = recordLanguage;
        this.recordPhase = recordPhase;
        this.recordNumber = recordNumber;
    ...
    protected ModelModuleAutobiographyQuestion(Parcel in) {
    ...
    public static final Creator<ModelModuleAutobiographyQuestion> CREATOR = new Creator<ModelModuleAutobiographyQuestion>() {
        @Override
        public ModelModuleAutobiographyQuestion createFromParcel(Parcel source) {
            return new ModelModuleAutobiographyQuestion(source);
        }

        @Override
        public ModelModuleAutobiographyQuestion[] newArray(int size) {
            return new ModelModuleAutobiographyQuestion[size];
        }
    };
}
