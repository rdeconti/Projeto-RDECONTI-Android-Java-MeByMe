...
public class ModelModulePersonalityAnswer implements Parcelable {
    ...
    public ModelModulePersonalityAnswer() {
    ...
    protected ModelModulePersonalityAnswer(Parcel in) {
    ...
    public static final Creator<ModelModulePersonalityAnswer> CREATOR = new Creator<ModelModulePersonalityAnswer>() {
        @Override
        public ModelModulePersonalityAnswer createFromParcel(Parcel source) {
            return new ModelModulePersonalityAnswer(source);
        }

        @Override
        public ModelModulePersonalityAnswer[] newArray(int size) {
            return new ModelModulePersonalityAnswer[size];
        }
    };
}
