...
public class ModelModuleChallengeQuestion implements Parcelable {
    ...
    public ModelModuleChallengeQuestion() {
    ...
    public ModelModuleChallengeQuestion(String recordId, String recordLanguage, String recordNumber, String recordText, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordLanguage = recordLanguage;
        this.recordNumber = recordNumber;
        this.recordText = recordText;
    ...
    protected ModelModuleChallengeQuestion(Parcel in) {
    ...
    public static final Creator<ModelModuleChallengeQuestion> CREATOR = new Creator<ModelModuleChallengeQuestion>() {
        @Override
        public ModelModuleChallengeQuestion createFromParcel(Parcel source) {
            return new ModelModuleChallengeQuestion(source);
        }

        @Override
        public ModelModuleChallengeQuestion[] newArray(int size) {
            return new ModelModuleChallengeQuestion[size];
        }
    };
}
