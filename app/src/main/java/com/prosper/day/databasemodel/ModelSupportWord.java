...
public class ModelSupportWord implements Parcelable {
    ...
    public ModelSupportWord(String recordId, String recordLanguage, String recordNumber, String recordText, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordLanguage = recordLanguage;
        this.recordNumber = recordNumber;
        this.recordText = recordText;
    ...
    protected ModelSupportWord(Parcel in) {
    ...
    public static final Creator<ModelSupportWord> CREATOR = new Creator<ModelSupportWord>() {
        @Override
        public ModelSupportWord createFromParcel(Parcel source) {
            return new ModelSupportWord(source);
        }

        @Override
        public ModelSupportWord[] newArray(int size) {
            return new ModelSupportWord[size];
        }
    };
}
