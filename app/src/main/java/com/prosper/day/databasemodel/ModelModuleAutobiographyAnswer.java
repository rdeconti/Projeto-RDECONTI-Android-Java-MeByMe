...
public class ModelModuleAutobiographyAnswer implements Parcelable {
    ...
    public ModelModuleAutobiographyAnswer() {
    ...
    public ModelModuleAutobiographyAnswer(String recordId, String recordUserId, String recordPhase, String recordNumber, String recordStatus, String recordExperience, String recordQuestion, String recordAnswer, String recordNumberPoints, String recordNumberSharing, String recordNumberPhotos, String recordNumberActions, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordUserId = recordUserId;
        this.recordPhase = recordPhase;
        this.recordNumber = recordNumber;
    ...
    protected ModelModuleAutobiographyAnswer(Parcel in) {
    ...
    public static final Creator<ModelModuleAutobiographyAnswer> CREATOR = new Creator<ModelModuleAutobiographyAnswer>() {
        @Override
        public ModelModuleAutobiographyAnswer createFromParcel(Parcel source) {
            return new ModelModuleAutobiographyAnswer(source);
        }

        @Override
        public ModelModuleAutobiographyAnswer[] newArray(int size) {
            return new ModelModuleAutobiographyAnswer[size];
        }
    };
}
