...
public class ModelModuleReflectionAnswer implements Parcelable {
    ...
    public ModelModuleReflectionAnswer() {
    ...
    protected ModelModuleReflectionAnswer(Parcel in) {
    ...
    public static final Creator<ModelModuleReflectionAnswer> CREATOR = new Creator<ModelModuleReflectionAnswer>() {
        @Override
        public ModelModuleReflectionAnswer createFromParcel(Parcel source) {
            return new ModelModuleReflectionAnswer(source);
        }

        @Override
        public ModelModuleReflectionAnswer[] newArray(int size) {
            return new ModelModuleReflectionAnswer[size];
        }
    };
}
