...
public class ModelModuleRecognitionAnswer implements Parcelable {
    ...
    public ModelModuleRecognitionAnswer() {
    ...
    protected ModelModuleRecognitionAnswer(Parcel in) {
    ...
    public static final Creator<ModelModuleRecognitionAnswer> CREATOR = new Creator<ModelModuleRecognitionAnswer>() {
        @Override
        public ModelModuleRecognitionAnswer createFromParcel(Parcel source) {
            return new ModelModuleRecognitionAnswer(source);
        }

        @Override
        public ModelModuleRecognitionAnswer[] newArray(int size) {
            return new ModelModuleRecognitionAnswer[size];
        }
    };
}
