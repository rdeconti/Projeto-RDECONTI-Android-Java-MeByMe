...
public class ModelModuleLifeAnswer implements Parcelable {
    ...
    public ModelModuleLifeAnswer(String recordId, String recordUserId, String recordPhase, String recordNumber, String recordStatus, String recordExperience, String recordGrade, String recordQuestion, String recordNumberPoints, String recordNumberSharing, String recordNumberPhotos, String recordNumberActions, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordUserId = recordUserId;
        this.recordPhase = recordPhase;
        this.recordNumber = recordNumber;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.recordGrade);
    ...
    protected ModelModuleLifeAnswer(Parcel in) {
        ...
        this.recordGrade = in.readString();
    ...
    public static final Creator<ModelModuleLifeAnswer> CREATOR = new Creator<ModelModuleLifeAnswer>() {
        @Override
        public ModelModuleLifeAnswer createFromParcel(Parcel source) {
            return new ModelModuleLifeAnswer(source);
        }

        @Override
        public ModelModuleLifeAnswer[] newArray(int size) {
            return new ModelModuleLifeAnswer[size];
        }
    };
}
