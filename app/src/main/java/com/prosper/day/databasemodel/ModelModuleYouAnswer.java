...
public class ModelModuleYouAnswer implements Parcelable {
    ...
    protected ModelModuleYouAnswer(Parcel in) {
    ...
    public static final Creator<ModelModuleYouAnswer> CREATOR = new Creator<ModelModuleYouAnswer>() {
        @Override
        public ModelModuleYouAnswer createFromParcel(Parcel source) {
            return new ModelModuleYouAnswer(source);
        }

        @Override
        public ModelModuleYouAnswer[] newArray(int size) {
            return new ModelModuleYouAnswer[size];
        }
    };
}
