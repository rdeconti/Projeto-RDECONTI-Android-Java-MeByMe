...
public class ModelSupportPointsUser implements Parcelable {
    ...
    public ModelSupportPointsUser(String recordId, String recordUserId, String recordPhase, String recordNumber, String recordStatus, String recordNumberPoints, String recordNumberSharing, String recordNumberPhotos, String recordNumberActions, String recordDateCreation, String recordDateUpdate, String recordDateSync) {
        this.recordId = recordId;
        this.recordUserId = recordUserId;
        this.recordPhase = recordPhase;
        this.recordNumber = recordNumber;
    ...
    protected ModelSupportPointsUser(Parcel in) {
    ...
    public static final Creator<ModelSupportPointsUser> CREATOR = new Creator<ModelSupportPointsUser>() {
        @Override
        public ModelSupportPointsUser createFromParcel(Parcel source) {
            return new ModelSupportPointsUser(source);
        }

        @Override
        public ModelSupportPointsUser[] newArray(int size) {
            return new ModelSupportPointsUser[size];
        }
    };
}
