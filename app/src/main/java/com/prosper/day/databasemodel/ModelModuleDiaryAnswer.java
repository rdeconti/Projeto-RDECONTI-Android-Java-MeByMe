...
public class ModelModuleDiaryAnswer implements Parcelable {
    ...
    protected ModelModuleDiaryAnswer(Parcel in) {
    ...
    public static final Creator<ModelModuleDiaryAnswer> CREATOR = new Creator<ModelModuleDiaryAnswer>() {
        @Override
        public ModelModuleDiaryAnswer createFromParcel(Parcel source) {
            return new ModelModuleDiaryAnswer(source);
        }

        @Override
        public ModelModuleDiaryAnswer[] newArray(int size) {
            return new ModelModuleDiaryAnswer[size];
        }
    };
}
