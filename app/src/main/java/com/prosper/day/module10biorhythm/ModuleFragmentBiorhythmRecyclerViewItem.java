...
public class ModuleFragmentBiorhythmRecyclerViewItem extends Fragment {
    ...
    List<ModelModuleBiorhythmAnswer> listAll;


    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentBiorhythmRecyclerViewItem() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = inflater.inflate(R.layout.biorhythm_recyclerview_fragment_list, viewGroup, false);
    ...
    private void generateRecyclerView() {
        ...
        switch (stringCurrentPhaseCode) {
            ...
            case BIORHYTHM_PHASE_CODE_10_OV:
                listAll = SqliteModuleBiorhythmAnswer.sqliteGetAll(mContext, mCurrentButtonFunction);
                break;
            ...
            case BIORHYTHM_PHASE_CODE_10_09:
                listAll = SqliteModuleBiorhythmAnswer.sqliteGetPhase(mContext, stringCurrentPhaseCode, mCurrentButtonFunction);
                break;
         ...
         if (Objects.requireNonNull(listAll).size() == INT_NUMBER_00) {
            ...
            mRecyclerView.setAdapter(new ModuleFragmentBiorhythmRecyclerViewList(listAll, mContext));
