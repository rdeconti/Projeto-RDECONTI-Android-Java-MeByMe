...
public class ModuleFragmentPersonalityGraphEvolution extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentPersonalityGraphEvolution() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.personality_graph_fragment, viewGroup, false);
    ...
    private void readDataFromDatabase() {
        ...
        SqliteModulePersonalityAnswer.sqliteGraphEvolution(mContext);
