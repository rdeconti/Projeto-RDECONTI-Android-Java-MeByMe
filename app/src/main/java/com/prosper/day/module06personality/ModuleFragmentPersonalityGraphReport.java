...
public class ModuleFragmentPersonalityGraphReport extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentPersonalityGraphReport() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.personality_report_fragment, viewGroup, false);
    ...
    private void initializeMultidimensionalArray() {
        ...
        mMultiArrayTotal = SqliteModulePersonalityAnswer.sqliteReportAnalysis(mContext);
    ...
    private void generateReportBodyNumber() {
        ...
        for(mIndexArrayLine = 0; mIndexArrayLine < PERSONALITY_REAL_PHASES; mIndexArrayLine++){
    ...
    private void generateReportLineName() {
        ...
        switch (mIndexArrayLine) {
            ...
            case INT_NUMBER_00:
                addToTableRow(mContext.getString(R.string.label_personality_questions), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_01:
                addToTableRow(mContext.getString(R.string.label_personality_result), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_02:
                addToTableRow(mContext.getString(R.string.label_hippocrates_questions), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_03:
                addToTableRow(mContext.getString(R.string.label_hippocrates_result), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_04:
                addToTableRow(mContext.getString(R.string.label_enneagram_questions), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_05:
                addToTableRow(mContext.getString(R.string.label_enneagram_result), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_06:
                addToTableRow(mContext.getString(R.string.label_behavioral_questions), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_07:
                addToTableRow(mContext.getString(R.string.label_behavioral_result), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_08:
                addToTableRow(mContext.getString(R.string.label_neurolinguistics_questions), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_09:
                addToTableRow(mContext.getString(R.string.label_neurolinguistics_result), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;
