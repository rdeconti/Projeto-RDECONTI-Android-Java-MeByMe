...
public class ModuleFragmentPersonalityRecyclerViewItemResult extends Fragment {
    ...
    List<ModelModulePersonalityResult> listAll;

    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentPersonalityRecyclerViewItemResult() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = inflater.inflate(R.layout.personality_recyclerview_fragment_list_result, viewGroup, false);
    ...
    private void generateRecyclerView() {
        ...
        switch (stringCurrentPhaseCode) {
            ...
            case PERSONALITY_PHASE_CODE_06_10:
                listAll = SqliteModulePersonalityResult.sqliteGetPhase(mContext, stringCurrentPhaseCode, mCurrentButtonFunction);
                break;
        ...
        if (Objects.requireNonNull(listAll).size() == INT_NUMBER_00) {
            ...
            mRecyclerView.setAdapter(new ModuleFragmentPersonalityRecyclerViewListResult(listAll, mContext));
