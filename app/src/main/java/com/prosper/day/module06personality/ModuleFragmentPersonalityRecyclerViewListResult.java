...
public class ModuleFragmentPersonalityRecyclerViewListResult extends RecyclerView.Adapter<ModuleFragmentPersonalityRecyclerViewListResult.ViewHolder> {
    ...
    private final List<ModelModulePersonalityResult> mValues;

    // *********************************************************************************************
    // *********************************************************************************************
    ModuleFragmentPersonalityRecyclerViewListResult(List<ModelModulePersonalityResult> items, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.personality_recyclerview_fragment_item_result, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        ModelModulePersonalityResult model = mValues.get(position);
        ...
        holder.mView.setOnClickListener(view -> {
            ...
            mStringCurrentFragment = "ModuleFragmentPersonalityRecyclerViewListResult";
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    private void uploadLayoutData(ViewHolder holder, ModelModulePersonalityResult model) {

        mStringPhaseCode = model.getRecordPhase();
        mStringQuestionText = model.getRecordText();
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ModelModulePersonalityResult recyclerViewItem;
