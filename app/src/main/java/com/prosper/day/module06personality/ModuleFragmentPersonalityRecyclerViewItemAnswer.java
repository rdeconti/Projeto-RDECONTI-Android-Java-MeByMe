...
public class ModuleFragmentPersonalityRecyclerViewItemAnswer extends Fragment {
    ...
    List<ModelModulePersonalityAnswer> listAll;

    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentPersonalityRecyclerViewItemAnswer() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = inflater.inflate(R.layout.personality_recyclerview_fragment_list_answer, viewGroup, false);
    ...
    private void generateRecyclerView() {
        ...
        switch (stringCurrentPhaseCode) {
            ...
            case PERSONALITY_PHASE_CODE_06_OV:
                listAll = SqliteModulePersonalityAnswer.sqliteGetPhase(mContext, stringCurrentPhaseCode, mCurrentButtonFunction);
                break;
        ...
        if (Objects.requireNonNull(listAll).size() == INT_NUMBER_00) {
            ...
            mRecyclerView.setAdapter(new ModuleFragmentPersonalityRecyclerViewListAnswer(listAll, mContext));
