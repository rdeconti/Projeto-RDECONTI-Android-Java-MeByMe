...
public class ModuleFragmentPersonalityRecyclerViewItemEnneagram extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentPersonalityRecyclerViewItemEnneagram() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = inflater.inflate(R.layout.personality_recyclerview_fragment_list_choice_enneagram, viewGroup, false);
    ...
    private void generateRecyclerView() {
        ...
        if (Objects.requireNonNull(listAll).size() == INT_NUMBER_00) {
            ...
            mRecyclerView.setAdapter(new ModuleFragmentPersonalityRecyclerViewListEnneagram(listAll, mContext));
