...
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.PHOTO_SUB_PHASES;
...
public class ModuleFragmentPhotoControl extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentPhotoControl() {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                switch (position) {
                    ...
                    case INT_NUMBER_00:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_GA;
                        break;
                    ...
                    case INT_NUMBER_03:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_03;
                        break;

                    case INT_NUMBER_04:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_04;
                        break;

                    case INT_NUMBER_05:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_05;
                        break;

                    case INT_NUMBER_06:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_06;
                        break;

                    case INT_NUMBER_07:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_07;
                        break;

                    case INT_NUMBER_08:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_09;
                        break;

                    case INT_NUMBER_09:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_10;
                        break;

                    case INT_NUMBER_10:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_11;
                        break;

                    case INT_NUMBER_11:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_12;
                        break;

                    case INT_NUMBER_12:
                        stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_19;
                        break;
    ...
    public class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case INT_NUMBER_00:
                    stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_GA;
                    return new ModuleFragmentPhotoGraphAnalysis();

                case INT_NUMBER_01:
                    stringCurrentPhaseCode = PHOTO_PHASE_CODE_14_OV;
                    return new ModuleFragmentPhotoRecyclerViewItem();
