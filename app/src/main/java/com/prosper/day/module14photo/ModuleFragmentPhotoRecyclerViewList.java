...
import com.prosper.day.applicationsupportclasses.SupportGeneratePhaseQuestionHeader;
...
public class ModuleFragmentPhotoRecyclerViewList extends RecyclerView.Adapter<ModuleFragmentPhotoRecyclerViewList.ViewHolder> {
    ...
    private final List<ModelModulePhotoAnswer> mValues;

    // *********************************************************************************************
    // *********************************************************************************************
    ModuleFragmentPhotoRecyclerViewList(List<ModelModulePhotoAnswer> items, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.photo_recyclerview_fragment_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        ModelModulePhotoAnswer model = mValues.get(position);
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    private void uploadLayoutData(ViewHolder holder, ModelModulePhotoAnswer model) {
        ...
        mStringQuestionHeader = SupportGeneratePhaseQuestionHeader.supportGeneratePhaseQuestionHeader(mContext, mStringPhaseCode, mStringPhaseNumber);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ModelModulePhotoAnswer recyclerViewItem;
