...
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.ACTION_SUB_PHASES;
...
public class ModuleFragmentActionControl extends Fragment {
    ...
    private final int[] mTabLayoutIcons = {
            ...
            R.drawable.tab_icon_costs_white_24dp,
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentActionControl() {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                switch (position) {
                    ...
                    case INT_NUMBER_01:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GA;
                        break;

                    case INT_NUMBER_02:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GC;
                        break;

                    case INT_NUMBER_03:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GP;
                        break;

                    case INT_NUMBER_04:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GF;
                        break;

                    case INT_NUMBER_05:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_OV;
                        break;

                    case INT_NUMBER_06:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_02;
                        break;

                    case INT_NUMBER_07:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_03;
                        break;

                    case INT_NUMBER_08:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_04;
                        break;

                    case INT_NUMBER_09:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_05;
                        break;

                    case INT_NUMBER_10:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_06;
                        break;

                    case INT_NUMBER_11:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_07;
                        break;

                    case INT_NUMBER_12:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_09;
                        break;

                    case INT_NUMBER_13:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_10;
                        break;

                    case INT_NUMBER_14:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_11;
                        break;

                    case INT_NUMBER_15:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_12;
                        break;

                    case INT_NUMBER_16:
                        stringCurrentPhaseCode = ACTION_PHASE_CODE_08_19;
                        break;
    ...
    public class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case INT_NUMBER_00:
                    stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GE;
                    return new ModuleFragmentActionGraphEvolution();

                case INT_NUMBER_01:
                    stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GA;
                    return new ModuleFragmentActionGraphReport();

                case INT_NUMBER_02:
                    stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GC;
                    return new ModuleFragmentActionGraphCosts();

                case INT_NUMBER_03:
                    stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GP;
                    return new ModuleFragmentActionGraphPriority();

                case INT_NUMBER_04:
                    stringCurrentPhaseCode = ACTION_PHASE_CODE_08_GF;
                    return new ModuleFragmentActionGraphFrequency();

                case INT_NUMBER_05:
                    stringCurrentPhaseCode = ACTION_PHASE_CODE_08_OV;
                    return new com.prosper.day.module08action.ModuleFragmentActionRecyclerViewItem();
                ...
                case INT_NUMBER_15:
                    stringCurrentPhaseCode = ACTION_PHASE_CODE_08_12;
                    return new ModuleFragmentActionRecyclerViewItem();
