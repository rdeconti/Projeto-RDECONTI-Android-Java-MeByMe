...
public class ModuleFragmentActionGraphPriority extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentActionGraphPriority() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        SqliteModuleActionAnswer.sqliteGraphPriority(mContext);
    ...
    private void generatePieChart() {
        ...
        if (value1 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value1, getString(R.string.label_high), 1));
        }

        if (value2 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value2, getString(R.string.label_medium), 2));
        }

        if (value3 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value3, getString(R.string.label_low), 3));
        }

        if (value4 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value4, getString(R.string.label_none), 4));
        }
    ...
    private void generateHorizontalBarChart() {
        ...
        final String[] mTableLabels = new String[]
                {   mContext.getString(R.string.label_high),
                    mContext.getString(R.string.label_medium),
                    mContext.getString(R.string.label_low),
