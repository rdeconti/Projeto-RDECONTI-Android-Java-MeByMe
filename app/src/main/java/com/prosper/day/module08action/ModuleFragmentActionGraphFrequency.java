...
public class ModuleFragmentActionGraphFrequency extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentActionGraphFrequency() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.action_graph_fragment, viewGroup, false);


        initializeLayoutData();


        SqliteModuleActionAnswer.sqliteGraphFrequency(mContext);
    ...
    private void generatePieChart() {
        ...
        if (value1 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value1, getString(R.string.label_daily), 1));
        }

        if (value2 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value2, getString(R.string.label_weekly), 2));
        }

        if (value3 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value3, getString(R.string.label_monthly), 3));
        }

        if (value4 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value4, getString(R.string.label_annual), 4));
        }

        if (value5 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_none), 5));
        }
    ...
    private void generateHorizontalBarChart() {
        ...
        final String[] mTableLabels = new String[]
                {   mContext.getString(R.string.label_daily),
                    mContext.getString(R.string.label_weekly),
                    mContext.getString(R.string.label_monthly),
                    mContext.getString(R.string.label_annual),
