...
public class ModuleFragmentBeliefGraphEvolution extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentBeliefGraphEvolution() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.belief_graph_fragment, viewGroup, false);
    ...
    private void readDataFromDatabase() {
        ...
        SqliteModuleBeliefAnswer.sqliteGraphEvolution(mContext);
