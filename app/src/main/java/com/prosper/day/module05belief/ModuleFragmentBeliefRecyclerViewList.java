...
public class ModuleFragmentBeliefRecyclerViewList extends RecyclerView.Adapter<ModuleFragmentBeliefRecyclerViewList.ViewHolder> {
    ...
    private final List<ModelModuleBeliefAnswer> mValues;

    // *********************************************************************************************
    // *********************************************************************************************
    ModuleFragmentBeliefRecyclerViewList(List<ModelModuleBeliefAnswer> items, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recognition_recyclerview_fragment_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        ModelModuleBeliefAnswer model = mValues.get(position);
        ...
        holder.mView.setOnClickListener(view -> {
            ...
            mStringCurrentFragment = "ModuleFragmentBeliefRecyclerViewList";

            mAppCompatActivity = (AppCompatActivity) view.getContext();
            mAppCompatActivity.getSupportFragmentManager().beginTransaction()
                    .replace(R.id.mainConstraintLayout, new ModuleFragmentBeliefCrud(), mStringCurrentFragment)
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    private void uploadLayoutData(ViewHolder holder, ModelModuleBeliefAnswer model) {

        mStringPhaseCode = model.getRecordPhase();
        mStringPhaseNumber = model.getRecordSign();
        mStringStatusCode = model.getRecordStatus();
        mStringAnswerText = model.getRecordAnswerName();
        ...
        holder.mTextViewValueQuestion.setText(model.getRecordAnswerName());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ModelModuleBeliefAnswer recyclerViewItem;
