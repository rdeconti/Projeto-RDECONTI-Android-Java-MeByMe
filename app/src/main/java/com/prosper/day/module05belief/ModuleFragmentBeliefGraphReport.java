...
public class ModuleFragmentBeliefGraphReport extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentBeliefGraphReport() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.belief_report_fragment, viewGroup, false);
    ...
    private void initializeMultidimensionalArray() {
        ...
        mMultiArrayTotal = SqliteModuleBeliefAnswer.sqliteReportAnalysis(mContext);
    ...
    private void generateReportBodyNumber() {
        ...
        for(mIndexArrayLine = 0; mIndexArrayLine < BELIEF_REAL_PHASES; mIndexArrayLine++){
    ...
    private void generateReportLineName() {
        ...
        switch (mIndexArrayLine) {
            ...
            case INT_NUMBER_00:
                addToTableRow(mContext.getString(R.string.label_angel), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_01:
                addToTableRow(mContext.getString(R.string.label_aztec), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_02:
                addToTableRow(mContext.getString(R.string.label_brazilian), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_03:
                addToTableRow(mContext.getString(R.string.label_celtic), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_04:
                addToTableRow(mContext.getString(R.string.label_chinese), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_05:
                addToTableRow(mContext.getString(R.string.label_gypsy), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_06:
                addToTableRow(mContext.getString(R.string.label_egyptian), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_07:
                addToTableRow(mContext.getString(R.string.label_indian), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_08:
                addToTableRow(mContext.getString(R.string.label_mayan), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_09:
                addToTableRow(mContext.getString(R.string.label_occidental), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_10:
                addToTableRow(mContext.getString(R.string.label_shamanic), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_11:
                addToTableRow(mContext.getString(R.string.label_numerology), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_12:
                addToTableRow(mContext.getString(R.string.label_birthdate), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;
