...
public class SupportGeneratePhaseQuestionHeader {
    
    private static String mStringQuestionSubPhaseReturned;

    @SuppressLint("DefaultLocale")
    public static String supportGeneratePhaseQuestionHeader(Context mContext, String mStringPhaseCodeReceived, String mStringPhaseNumberReceived) {

        mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_not_found);

        switch (mStringPhaseCodeReceived) {

            case MAIN_PHASE_CODE_01_OV:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_overview);
                break;

            case MAIN_PHASE_CODE_01_CRUD:
            case MAIN_PHASE_CODE_01_GE:
            case MAIN_PHASE_CODE_01_GA:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_main);
                break;
            ...
            case YOU_PHASE_CODE_19_13:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_you);
                break;
            ...
            case MOOD_PHASE_CODE_02_05:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_mood);
                break;
            ...
            case AUTOBIOGRAPHY_PHASE_CODE_03_14:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_autobiography);
                break;
            ...
            case RECOGNITION_PHASE_CODE_04_11:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_recognition);
                break;
            ...
            case BELIEF_PHASE_CODE_05_13:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_belief);
                break;
            ...
            case PERSONALITY_PHASE_CODE_06_08:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_personality);
                break;
            ...
            case LIFE_PHASE_CODE_07_16:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_life);
                break;
            ...
            case ACTION_PHASE_CODE_08_19:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_action);
                break;
            ...
            case REFLECTION_PHASE_CODE_09_05:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_reflection);
                break;
            ...
            case BIORHYTHM_PHASE_CODE_10_OV:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_biorhythm);
                break;
            ...
            case CHALLENGE_PHASE_CODE_11_OV:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_challenge);
                break;
            ...
            case DIARY_PHASE_CODE_12_OV:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_diary);
                break;
            ...
            case USER_PHASE_CODE_13_OV:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_user);
                break;
            ...
            case PHOTO_PHASE_CODE_14_19:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_photos);
                break;
            ...
            case SHARING_PHASE_CODE_15_19:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_sharing);
                break;
            ...
            case MAIN_PHASE_CODE_01_13:
                mStringQuestionSubPhaseReturned = mContext.getString(R.string.label_help);
                break;
        ...
        return mStringQuestionSubPhaseReturned;
