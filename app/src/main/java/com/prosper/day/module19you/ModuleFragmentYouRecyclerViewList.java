...
public class ModuleFragmentYouRecyclerViewList extends RecyclerView.Adapter<ModuleFragmentYouRecyclerViewList.ViewHolder> {
    ...
    private final List<ModelModuleYouAnswer> mValues;

    // *********************************************************************************************
    // *********************************************************************************************
    ModuleFragmentYouRecyclerViewList(List<ModelModuleYouAnswer> items, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.you_recyclerview_fragment_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        ModelModuleYouAnswer model = mValues.get(position);
        ...
        holder.mView.setOnClickListener(view -> {
            ...
            mStringCurrentFragment = "ModuleFragmentYouRecyclerViewList";

            mAppCompatActivity = (AppCompatActivity) view.getContext();
            mAppCompatActivity.getSupportFragmentManager().beginTransaction()
                    .replace(R.id.mainConstraintLayout, new ModuleFragmentYouCrud(), mStringCurrentFragment)
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    private void uploadLayoutData(ViewHolder holder, ModelModuleYouAnswer model) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ModelModuleYouAnswer recyclerViewItem;
