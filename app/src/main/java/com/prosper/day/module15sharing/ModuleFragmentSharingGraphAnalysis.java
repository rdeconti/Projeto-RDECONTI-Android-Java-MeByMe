...
public class ModuleFragmentSharingGraphAnalysis extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentSharingGraphAnalysis() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = inflater.inflate(R.layout.reflection_graph_fragment, viewGroup, false);

        initializeLayoutData();

        SqliteModuleSharingAnswer.sqliteGraphAnalysis(mContext);
    ...
    private void generatePieChart() {
        ...
        if (value1 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value1, getString(R.string.label_mood), 1));
        }

        if (value2 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value2, getString(R.string.label_autobiography), 2));
        }

        if (value3 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value3, getString(R.string.label_recognition), 3));
        }

        if (value4 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value4, getString(R.string.label_belief), 4));
        }

        if (value5 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_personality), 5));
        }

        if (value6 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_life), 6));
        }

        if (value7 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_action), 7));
        }

        if (value8 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_reflection), 8));
        }

        if (value9 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_biorhythm), 9));
        }

        if (value10 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_challenge), 10));
        }

        if (value11 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_diary), 11));
        }

        if (value12 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_you), 12));
        }

        if (value13 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_reflection_05), 13));
        }
