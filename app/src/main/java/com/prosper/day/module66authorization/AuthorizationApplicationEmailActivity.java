...
public class AuthorizationApplicationEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.authorization_application_email_activity);
        ...
        mToolbar.setSubtitle(R.string.label_changeEmail);
        ...
        editTextOldEmail = findViewById(R.id.editText_old_email);
