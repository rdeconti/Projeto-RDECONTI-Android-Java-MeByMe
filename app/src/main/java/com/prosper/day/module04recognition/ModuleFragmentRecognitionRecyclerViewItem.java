...
public class ModuleFragmentRecognitionRecyclerViewItem extends Fragment {
    ...
    List<ModelModuleRecognitionAnswer> listAll;

    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentRecognitionRecyclerViewItem() {
    ...
    private void generateRecyclerView() {
        ...
        switch (stringCurrentPhaseCode) {
            ...
            case RECOGNITION_PHASE_CODE_04_OV:
                listAll = SqliteModuleRecognitionAnswer.sqliteGetAll(mContext, mCurrentButtonFunction);
                break;
            ...
            case RECOGNITION_PHASE_CODE_04_11:
                listAll = SqliteModuleRecognitionAnswer.sqliteGetPhase(mContext, stringCurrentPhaseCode, mCurrentButtonFunction);
                break;
        ...
        if (Objects.requireNonNull(listAll).size() == INT_NUMBER_00) {
            ...
            mRecyclerView.setAdapter(new ModuleFragmentRecognitionRecyclerViewList(listAll, mContext));
