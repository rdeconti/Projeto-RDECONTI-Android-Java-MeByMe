...
public class ModuleFragmentRecognitionGraphReport extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentRecognitionGraphReport() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recognition_report_fragment, viewGroup, false);
    ...
    private void initializeMultidimensionalArray() {
        ...
        mMultiArrayTotal = SqliteModuleRecognitionAnswer.sqliteReportAnalysis(mContext);
    ...
    private void generateReportBodyNumber() {
        ...
        for(mIndexArrayLine = 0; mIndexArrayLine < RECOGNITION_REAL_PHASES; mIndexArrayLine++){
    ...
    private void generateReportLineName() {
        ...
        switch (mIndexArrayLine) {
            ...
            case INT_NUMBER_00:
                addToTableRow(mContext.getString(R.string.label_weaknesses), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_01:
                addToTableRow(mContext.getString(R.string.label_strengths), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_02:
                addToTableRow(mContext.getString(R.string.label_skills), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_03:
                addToTableRow(mContext.getString(R.string.label_values), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_04:
                addToTableRow(mContext.getString(R.string.label_sabotage), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_05:
                addToTableRow(mContext.getString(R.string.label_limits), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_06:
                addToTableRow(mContext.getString(R.string.label_needs), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_07:
                addToTableRow(mContext.getString(R.string.label_emotions), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_08:
                addToTableRow(mContext.getString(R.string.label_fears), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_09:
                addToTableRow(mContext.getString(R.string.label_sins), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;

            case INT_NUMBER_10:
                addToTableRow(mContext.getString(R.string.label_virtues), Color.WHITE, Color.TRANSPARENT, Gravity.LEFT);
                break;
