...
public class ModuleFragmentRecognitionGraphEvolution extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentRecognitionGraphEvolution() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recognition_graph_fragment, viewGroup, false);
    ...
    private void readDataFromDatabase() {
        ...
        SqliteModuleRecognitionAnswer.sqliteGraphEvolution(mContext);
