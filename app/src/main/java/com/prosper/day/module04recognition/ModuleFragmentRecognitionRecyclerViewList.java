...
public class ModuleFragmentRecognitionRecyclerViewList extends RecyclerView.Adapter<ModuleFragmentRecognitionRecyclerViewList.ViewHolder> {
    ...
    private final List<ModelModuleRecognitionAnswer> mValues;

    // *********************************************************************************************
    // *********************************************************************************************
    ModuleFragmentRecognitionRecyclerViewList(List<ModelModuleRecognitionAnswer> items, Context context) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        ModelModuleRecognitionAnswer model = mValues.get(position);
        ...
        holder.mView.setOnClickListener(view -> {
            ...
            mStringCurrentFragment = "ModuleFragmentRecognitionRecyclerViewList";

            mAppCompatActivity = (AppCompatActivity) view.getContext();
            mAppCompatActivity.getSupportFragmentManager().beginTransaction()
                    .replace(R.id.mainConstraintLayout, new ModuleFragmentRecognitionCrud(), mStringCurrentFragment)
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    private void uploadLayoutData(ViewHolder holder, ModelModuleRecognitionAnswer model) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ModelModuleRecognitionAnswer recyclerViewItem;
