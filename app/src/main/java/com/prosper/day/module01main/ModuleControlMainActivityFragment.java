...
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.MAIN_PHASE_CODE_01_GA;
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.MAIN_PHASE_CODE_01_GE;
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.MAIN_PHASE_CODE_01_OV;
import static com.prosper.day.applicationdefinition.ApplicationDefinitionCodePhase.MAIN_SUB_PHASES;
...
public class ModuleControlMainActivityFragment extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleControlMainActivityFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        stringCurrentPhaseCode = MAIN_PHASE_CODE_01_AD;
        stringCurrentShowCaseId = MAIN_PHASE_CODE_01_AD;
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                switch (position) {
                    ...
                    case INT_NUMBER_02:
                        stringCurrentPhaseCode = MAIN_PHASE_CODE_01_GE;
                        break;

                    case INT_NUMBER_03:
                        stringCurrentPhaseCode = MAIN_PHASE_CODE_01_GA;
                        break;
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    private void presentApplicationHelp() {

        stringCurrentPhaseCode = MAIN_PHASE_CODE_01_AD;

        mStringCurrentFragment = "ModuleControlMainActivityFragment";
        mAppCompatActivity = (AppCompatActivity) mView.getContext();

        mAppCompatActivity.getSupportFragmentManager().beginTransaction()
                .replace(R.id.mainConstraintLayout, new ModuleFragmentDocumentHelp(), mStringCurrentFragment)
    ...
    public class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        final String[] pageTitles =
                ...
                {
                        mContext.getString(R.string.label_advice),
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case INT_NUMBER_00:
                    stringCurrentPhaseCode = MAIN_PHASE_CODE_01_AD;
                    return new ModuleControlMainGiveAdviceFragment();

                case INT_NUMBER_01:
                    stringCurrentPhaseCode = MAIN_PHASE_CODE_01_OV;
                    return new ModuleControlMainOverviewFragment();

                case INT_NUMBER_02:
                    stringCurrentPhaseCode = MAIN_PHASE_CODE_01_GE;
                    return new ModuleControlMainGraphEvolutionFragment();

                case INT_NUMBER_03:
                    stringCurrentPhaseCode = MAIN_PHASE_CODE_01_GA;
                    return new ModuleControlMainGraphAnalysisFragment();
