...
public class ModuleControlMainGraphAnalysisFragment extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleControlMainGraphAnalysisFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.main_module_control_main_fragment_graph, viewGroup, false);

        initializeLayoutData();

        SqliteSupportPointsUser.sqliteGraphAnalysis(mContext);
        ...
        value6 = Float.parseFloat(String.valueOf(INT_GRAPH_VALUE_06));
        value7 = Float.parseFloat(String.valueOf(INT_GRAPH_VALUE_07));
        value8 = Float.parseFloat(String.valueOf(INT_GRAPH_VALUE_08));
        value9 = Float.parseFloat(String.valueOf(INT_GRAPH_VALUE_09));
        value10 = Float.parseFloat(String.valueOf(INT_GRAPH_VALUE_10));
        value11 = Float.parseFloat(String.valueOf(INT_GRAPH_VALUE_11));
        value12 = Float.parseFloat(String.valueOf(INT_GRAPH_VALUE_12));
        value13 = Float.parseFloat(String.valueOf(INT_GRAPH_VALUE_13));
    ...
    private void generatePieChart() {
        ...
        if (value1 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value2, getString(R.string.label_mood), 2));
        }

        if (value2 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value3, getString(R.string.label_autobiography), 3));
        }

        if (value3 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value4, getString(R.string.label_recognition), 4));
        }

        if (value4 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_belief), 5));
        }

        if (value5 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value6, getString(R.string.label_personality), 6));
        }

        if (value6 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value7, getString(R.string.label_life), 7));
        }

        if (value7 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value7, getString(R.string.label_action), 7));
        }

        if (value8 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value7, getString(R.string.label_reflection), 7));
        }

        if (value9 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value7, getString(R.string.label_biorhythm), 7));
        }

        if (value10 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value7, getString(R.string.label_challenge), 7));
        }

        if (value11 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value7, getString(R.string.label_diary), 7));
        }

        if (value12 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value7, getString(R.string.label_feedbackFrom), 7));
        }

        if (value13 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value7, getString(R.string.label_you), 7));
        }
    ...
    private void generateHorizontalBarChart() {
        ...
        entries.add(new BarEntry(7f, value8));
        entries.add(new BarEntry(8f, value9));
        entries.add(new BarEntry(9f, value10));
        entries.add(new BarEntry(10f, value11));
        entries.add(new BarEntry(11f, value12));
        entries.add(new BarEntry(12f, value13));
        ...
        final String[] mTableLabels = new String[]
                {   mContext.getString(R.string.label_mood),
                        ...
                        mContext.getString(R.string.label_action),
                        ...
                        mContext.getString(R.string.label_feedbackFrom),
