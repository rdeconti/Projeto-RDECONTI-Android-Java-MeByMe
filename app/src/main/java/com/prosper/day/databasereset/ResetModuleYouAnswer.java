...
import static com.prosper.day.databasesqlite.SqliteModuleYouAnswer.sqliteInsert;

public class ResetModuleYouAnswer {
    ...
    private static List<ModelModuleYouQuestion> mArrayListQuestions;

    // *********************************************************************************************
    // *********************************************************************************************
    public static void resetModuleYouAnswer(Context context) {
        ...
        mArrayListQuestions = SqliteModuleYouQuestion.sqliteGetAll(context);
