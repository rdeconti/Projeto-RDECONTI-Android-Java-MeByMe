...
import static com.prosper.day.databasesqlite.SqliteModuleDiaryAnswer.sqliteInsert;

public class ResetModuleDiaryAnswer {
    ...
    public static void resetModuleDiaryAnswer(Context context) {

        recordUserId = stringCurrentUserFirebaseUserId;
        recordPhase = DIARY_PHASE_CODE_12_OV;

        recordStatus = STATUS_NEW;
        recordExperience = EXPERIENCE_NORMAL;

        recordAnswer = context.getString(R.string.label_none_diary);
