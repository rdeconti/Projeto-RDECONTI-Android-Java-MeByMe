...
import static com.prosper.day.databasesqlite.SqliteSupportAdvice.sqliteInsert;

public class ResetSupportAdvice {
    ...
    private static List<ModelSupportAdvice> mArrayListAnswer;

    // *********************************************************************************************
    // *********************************************************************************************
    @SuppressLint("DefaultLocale")
    public static void resetSupportAdvice(Context context) {
