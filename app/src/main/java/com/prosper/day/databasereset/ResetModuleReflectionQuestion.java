...
import static com.prosper.day.databasesqlite.SqliteModuleReflectionQuestion.sqliteInsert;

public class ResetModuleReflectionQuestion {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static void resetModuleReflectionQuestion(Context context) {
        ...
        mDatabaseReference = mFirebaseDatabase.getReference(TABLE_MODULE_REFLECTION_QUESTION);
