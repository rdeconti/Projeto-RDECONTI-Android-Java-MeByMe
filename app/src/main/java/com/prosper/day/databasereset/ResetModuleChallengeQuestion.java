...
import static com.prosper.day.databasesqlite.SqliteModuleChallengeQuestion.sqliteInsert;

public class ResetModuleChallengeQuestion {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public static void resetModuleChallengeQuestion(Context context) {
        ...
        mDatabaseReference = mFirebaseDatabase.getReference(TABLE_MODULE_CHALLENGE_QUESTION);
