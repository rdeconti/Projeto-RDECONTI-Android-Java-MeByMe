package com.prosper.day.applicationfileprovider;
...
public class GenericFileProvider extends ContentProvider {
    ...
    @Override
    public int update(@NonNull Uri uri, @Nullable ContentValues mContentValues, @Nullable String selection, @Nullable String[] selectionArgs) {
        return INT_NUMBER_00;
    }
}
