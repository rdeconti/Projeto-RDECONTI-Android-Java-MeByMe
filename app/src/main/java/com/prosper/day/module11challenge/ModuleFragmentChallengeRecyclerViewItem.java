...
public class ModuleFragmentChallengeRecyclerViewItem extends Fragment {
    ...
    List<ModelModuleChallengeAnswer> listAll;

    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentChallengeRecyclerViewItem() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mView = inflater.inflate(R.layout.challenge_recyclerview_fragment_list, viewGroup, false);
    ...
    private void generateRecyclerView() {
        ...
        switch (stringCurrentPhaseCode) {
            ...
            case CHALLENGE_PHASE_CODE_11_OV:
                listAll = SqliteModuleChallengeAnswer.sqliteGetAll(mContext, mCurrentButtonFunction);
                break;
        ...
        if (Objects.requireNonNull(listAll).size() == INT_NUMBER_00) {
            ...
            mRecyclerView.setAdapter(new ModuleFragmentChallengeRecyclerViewList(listAll, mContext));
