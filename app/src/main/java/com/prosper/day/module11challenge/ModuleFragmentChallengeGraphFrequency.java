...
public class ModuleFragmentChallengeGraphFrequency extends Fragment {
    ...
    // *********************************************************************************************
    // *********************************************************************************************
    public ModuleFragmentChallengeGraphFrequency() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        SqliteModuleChallengeAnswer.sqliteGraphFrequency(mContext);
    ...
    private void generatePieChart() {
        ...
        if (value2 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value2, getString(R.string.label_daily), 2));
        }

        if (value3 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value3, getString(R.string.label_weekly), 3));
        }

        if (value4 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value4, getString(R.string.label_monthly), 4));
        }

        if (value5 > INT_NUMBER_00) {
            pieEntries.add(new PieEntry(value5, getString(R.string.label_annual), 5));
        }
